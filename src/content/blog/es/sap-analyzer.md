...
Código: [`aitorevi/connect-analyzer`](https://github.com/aitorevi/connect-analyzer). Demo en vivo: **[sap-analyzer.vercel.app](https://sap-analyzer.vercel.app)** (la primera carga puede tardar ~30 s: el backend y el mock duermen en el tier gratuito de Render).
