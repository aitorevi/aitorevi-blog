...
const GRADIENT_BY_TONE: Record<ButtonTone, string> = {
  blue: 'border border-accent-blue/50 bg-gradient-to-r from-accent-blue/10 to-accent-blue/20 text-blue-700 dark:text-accent-blue hover:border-accent-blue/80 hover:from-accent-blue/20 hover:to-accent-blue/30 hover:shadow-[0_10px_30px_-10px_rgba(96,165,250,0.4)] dark:from-accent-blue/15 dark:to-accent-blue/25',
  violet:
    'border border-accent-violet/50 bg-gradient-to-r from-accent-violet/10 to-accent-violet/20 text-violet-700 dark:text-accent-violet hover:border-accent-violet/80 hover:from-accent-violet/20 hover:to-accent-violet/30 hover:shadow-[0_10px_30px_-10px_rgba(167,139,250,0.4)] dark:from-accent-violet/15 dark:to-accent-violet/25',
  brand:
