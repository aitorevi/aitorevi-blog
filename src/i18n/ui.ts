...
export const ui: Record<Lang, Record<string, string>> = {
  es: {
    ...
    'home.cards.backend.desc': 'Java, C#, .NET, Node.js y SQL. APIs que modelan el dominio con cuidado y resisten el cambio.',
    ...
    'home.contact.subtitle': '// Abre tu cliente de correo',
    'home.contact.intro': '¿Tienes un proyecto en mente, una colaboración o simplemente quieres saludar? Cuéntame y te respondo pronto.',
    'home.contact.name': 'Nombre',
    'home.contact.email': 'Email',
    'home.contact.subject': 'Asunto',
    'home.contact.subjectPlaceholder': 'Colaboración en un proyecto frontend',
    'home.contact.message': 'Mensaje',
    'home.contact.messagePlaceholder': 'Cuéntame sobre lo que tienes en mente…',
    'home.contact.submit': 'Enviar',
    'home.contact.note': 'Este formulario abre tu cliente de correo con el mensaje pre-rellenado.',
    'home.p1':
  ...
  en: {
    ...
    'home.cards.backend.title': 'Backend Craft',
    'home.cards.backend.desc': 'Java, C#, .NET, Node.js and SQL. APIs that model the domain with care and stand the test of change.',
    'home.cards.frontend.title': 'Frontend Craft',
    ...
    'home.contact.subtitle': '// Opens your email client',
    'home.contact.intro': 'Got a project in mind, a collaboration idea, or just want to say hi? Drop me a line and I’ll get back to you soon.',
    'home.contact.name': 'Name',
    'home.contact.email': 'Email',
    'home.contact.subject': 'Subject',
    'home.contact.subjectPlaceholder': 'Collaboration on a frontend project',
    'home.contact.message': 'Message',
    'home.contact.messagePlaceholder': 'Tell me what you have in mind…',
    'home.contact.submit': 'Send',
    'home.contact.note': 'This form opens your email client with the message pre-filled.',
    'home.p1':
