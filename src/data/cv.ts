...
export const cvES: CvData = {
  ...
  skills: [
    ...
    { name: 'Backend', skills: ['Java', 'C# / .NET', 'Node.js', 'PostgreSQL', 'REST APIs'] },
    { name: 'Frontend y UX', skills: ['TypeScript', 'React', 'Next.js', 'Astro', 'TailwindCSS', 'Accessibility (A11y)', 'SEO'] },
    { name: 'Ingeniería de IA', skills: ['Prompt Engineering', 'Claude Code', 'AI Agents & Workflows', 'Gemini', 'Copilot'] },
...
export const cvEN: CvData = {
  ...
  skills: [
    ...
    { name: 'Backend', skills: ['Java', 'C# / .NET', 'Node.js', 'PostgreSQL', 'REST APIs'] },
    { name: 'Frontend & UX', skills: ['TypeScript', 'React', 'Next.js', 'Astro', 'TailwindCSS', 'Accessibility (A11y)', 'SEO'] },
    { name: 'AI Engineering', skills: ['Prompt Engineering', 'Claude Code', 'AI Agents & Workflows', 'Gemini', 'Copilot'] },
