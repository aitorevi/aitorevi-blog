...
export const katas: Kata[] = [
  ...
  },
  {
    ...
    title: 'Mars Rover',
    description: {
      es: 'Misma kata en Kotlin, pero jugando con dos estilos: outside-in e inside-out, uno junto al otro.',
      en: 'Same kata in Kotlin, playing with two styles side by side: outside-in and inside-out.',
    },
    tech: ['Kotlin'],
    concepts: ['TDD', 'Outside-In', 'Inside-Out'],
  ...
  },
  {
    ...
    title: 'AI Mars Rover',
    description: {
      es: 'Mars Rover resuelto íntegramente con IA, comparando la experiencia contra hacerlo a mano.',
      en: 'Mars Rover built entirely with AI assistance to compare the experience against doing it by hand.',
    },
    tech: ['TypeScript'],
    concepts: ['AI-Assisted', 'Experiment'],
