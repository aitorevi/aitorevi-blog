...
export function sortedKatas(): Kata[] {
  return [...katas].sort((a, b) => (a.date < b.date ? 1 : -1));
}

export function buildKatasCollectionSchema(lang: Lang, canonicalUrl: string, metaTitle: string, metaDescription: string) {
